...
public class SetupAppAutomationPart2 {
	public static void main(String args[]) throws MalformedURLException, InterruptedException {

		// Perform scroll operation till bottom of page and proceed to accept enabled functionality
	...
	WebElement accept = ad.findElement(By.id("com.sprint.trebl:id/accept_txt"));
		...
		while (!(((WebElement) accept).isEnabled())) {
			...
			if ((((WebElement) accept).isEnabled())) {
				...
				System.out.print("yayyy its donee!!!!");
